...
MAVLINK_MSG_ID_ENCODER_VALUE = 100
MAVLINK_MSG_ID_CLIENT_IP = 101
MAVLINK_MSG_ID_SELF_IP = 102
...
class MAVLink_encoder_value_message(MAVLink_message):
        '''
        Encoder value with stamp
        '''
        id = MAVLINK_MSG_ID_ENCODER_VALUE
        name = 'ENCODER_VALUE'
        fieldnames = ['value', 'stamp']
        ordered_fieldnames = [ 'value', 'stamp' ]
        format = '<II'
        ...
        def __init__(self, value, stamp):
                MAVLink_message.__init__(self, MAVLink_encoder_value_message.id, MAVLink_encoder_value_message.name)
                self._fieldnames = MAVLink_encoder_value_message.fieldnames
                self.value = value
                self.stamp = stamp

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 158, struct.pack('<II', self.value, self.stamp))

class MAVLink_client_ip_message(MAVLink_message):
        '''
        IP1.IP2.IP3.IP4
        '''
        id = MAVLINK_MSG_ID_CLIENT_IP
        name = 'CLIENT_IP'
        fieldnames = ['IP1', 'IP2', 'IP3', 'IP4']
        ordered_fieldnames = [ 'IP1', 'IP2', 'IP3', 'IP4' ]
        format = '<BBBB'
        ...
        def __init__(self, IP1, IP2, IP3, IP4):
                MAVLink_message.__init__(self, MAVLink_client_ip_message.id, MAVLink_client_ip_message.name)
                self._fieldnames = MAVLink_client_ip_message.fieldnames
                self.IP1 = IP1
                self.IP2 = IP2
                self.IP3 = IP3
                self.IP4 = IP4
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 63, struct.pack('<BBBB', self.IP1, self.IP2, self.IP3, self.IP4))

class MAVLink_self_ip_message(MAVLink_message):
        '''
        IP1.IP2.IP3.IP4
        '''
        id = MAVLINK_MSG_ID_SELF_IP
        name = 'SELF_IP'
        fieldnames = ['IP1', 'IP2', 'IP3', 'IP4']
        ordered_fieldnames = [ 'IP1', 'IP2', 'IP3', 'IP4' ]
        format = '<BBBB'
        ...
        def __init__(self, IP1, IP2, IP3, IP4):
                MAVLink_message.__init__(self, MAVLink_self_ip_message.id, MAVLink_self_ip_message.name)
                self._fieldnames = MAVLink_self_ip_message.fieldnames
                self.IP1 = IP1
                self.IP2 = IP2
                self.IP3 = IP3
                self.IP4 = IP4
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 219, struct.pack('<BBBB', self.IP1, self.IP2, self.IP3, self.IP4))


mavlink_map = {
        MAVLINK_MSG_ID_HEARTBEAT : MAVLink_heartbeat_message,
        MAVLINK_MSG_ID_ENCODER_VALUE : MAVLink_encoder_value_message,
        MAVLINK_MSG_ID_CLIENT_IP : MAVLink_client_ip_message,
        MAVLINK_MSG_ID_SELF_IP : MAVLink_self_ip_message,
}
...
class MAVLink(object):
        ...
        def encoder_value_encode(self, value, stamp):
                '''
                Encoder value with stamp
                ...
                '''
                return MAVLink_encoder_value_message(value, stamp)

        def encoder_value_send(self, value, stamp):
                '''
                Encoder value with stamp
                ...
                '''
                return self.send(self.encoder_value_encode(value, stamp))

        def client_ip_encode(self, IP1, IP2, IP3, IP4):
                '''
                IP1.IP2.IP3.IP4
                ...
                '''
                return MAVLink_client_ip_message(IP1, IP2, IP3, IP4)

        def client_ip_send(self, IP1, IP2, IP3, IP4):
                '''
                IP1.IP2.IP3.IP4
                ...
                '''
                return self.send(self.client_ip_encode(IP1, IP2, IP3, IP4))

        def self_ip_encode(self, IP1, IP2, IP3, IP4):
                '''
                IP1.IP2.IP3.IP4
                ...
                '''
                return MAVLink_self_ip_message(IP1, IP2, IP3, IP4)

        def self_ip_send(self, IP1, IP2, IP3, IP4):
                '''
                IP1.IP2.IP3.IP4
                ...
                '''
                return self.send(self.self_ip_encode(IP1, IP2, IP3, IP4))
